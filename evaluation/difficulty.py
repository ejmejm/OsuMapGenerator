import numpy as np
import math
from preprocessing.data_loading import load_beatmap_from_file_content
...
def anaylize_difficulty(data):

    try:
        meta, _, hitobjects = load_beatmap_from_file_content(data)
        ...
        print("error occurs in difficulty calculation")
        return {"difficulty": np.nan}
